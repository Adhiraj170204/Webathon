...
function OrderTracking() {
  return (
    <div className="flex overflow-hidden flex-col  ">
      <OrderHeader />
      <div className="flex flex-col items-center pt-px pb-5 mt-16 w-full bg-white rounded-lg border border-solid border-[color:var(--Gray-Scale-Gray-100,#E6E6E6)] max-md:mt-10 max-md:max-w-full">
